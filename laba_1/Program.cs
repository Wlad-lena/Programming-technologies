...
namespace Laba_1 {
    class Program {
        ...
        public static Tank[] GetTanks() {
            string? path;
            do {
                Console.WriteLine("Введите имя файла, содержащего таблицу резервуаров");
        ...
        public static Unit[] GetUnits() {
            string? path;
            do {
                Console.WriteLine("Введите имя файла, содержащего таблицу установок");
                path = Console.ReadLine();
            } while (path == "" || !File.Exists(path));
        ...
        public static Factory[] GetFactories() {
            string? path;
            do {
                Console.WriteLine("Введите имя файла, содержащего таблицу заводов");
                path = Console.ReadLine();
            } while (path == "" || !File.Exists(path));
